...
set(stdout_log "/home/paro/Pulpit/na-tdd-NA16/build/external/gtest/src/googletest-stamp/googletest-build-out.log")
set(stderr_log "/home/paro/Pulpit/na-tdd-NA16/build/external/gtest/src/googletest-stamp/googletest-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/paro/Pulpit/na-tdd-NA16/build/external/gtest/src/googletest-stamp/googletest-build-*.log")
  endif()
  ...
  set(msg "googletest build command succeeded.  See also /home/paro/Pulpit/na-tdd-NA16/build/external/gtest/src/googletest-stamp/googletest-build-*.log")
  message(STATUS "${msg}")
endif()
